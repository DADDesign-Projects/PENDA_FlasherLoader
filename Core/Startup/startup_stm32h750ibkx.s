...
/* DAD ==========================================================*/
  ...
  /* ---------------------------------------------------------- */
  /* Test magic word @ 0x38000000                               */
  /* ---------------------------------------------------------- */
    ldr     r0, =0x38000000         /* r0  = magic address      */
    ldr     r1, [r0]                /* r1  = loaded value       */
    ldr     r2, =0xBAD02850         /* r2  = reference value    */
    cmp     r1, r2                  /* compare                  */
    bne     NormalBoot              /* not ok -> normal boot    */

  /* ---------------------------------------------------------- */
  /* Clear magic (write 0x00000000 to same address)             */
  /* ---------------------------------------------------------- */
    mov     r1, #0
    str     r1, [r0]               /* *(0x38000000) = 0         */

  /* ---------------------------------------------------------- */
  /* Jump to app @ 0x24000000                                   */
  /* ---------------------------------------------------------- */
    ldr     r0, =0x24000000        /* r0 = app vector base      */
    ldr     sp, [r0, #0x00]        /* sp = vector 0 (stack top) */
    ldr     r1, [r0, #0x04]        /* r1 = vector 1 (Reset app) */
    bx      r1                     /* jump to app               */
